...
const App = () => {
  ...
  return (
    <>
    <h1 className='bg-black text-white p-5 text-5xl text-center font '>Bhumi's Todo List</h1>
    <form onSubmit={submitHandler}>
      ...
      />
      <button className='font-semibold bg-black text-white text-2xl px-3 py-2 rounded hover:bg-gray-800 m-5'>Add Task</button>
    </form>
    <hr/>
